...
Page({
        ...
        if (app.globalData.allUserInfo !== null) {
          wx.request({
            ...
            data: {
              ...
              skillCertificate: that.data.str
            },
            header: {
   ...
   */
  onShow: function () {
    if (app.globalData.allUserInfo !== null && app.globalData.allUserInfo.skillCertificate !== null) {
      this.setData({
        str: app.globalData.allUserInfo.skillCertificate
      })
    }
  },
