...
Page({
  ...
  saveNickName() {
    ...
    if (that.data.saveClickNum === 0) {
      ...
      } else if (that.data.str.length > 3) {
        wx.showToast({
          title: '请输入正确的民族',
          icon: 'none',
          duration: 2000
   ...
   */
  onShow: function() {
    if (app.globalData.allUserInfo !== null && app.globalData.allUserInfo.nationality !== null) {
      this.setData({
        str: app.globalData.allUserInfo.nationality
      })
    }
  },
